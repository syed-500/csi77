...
const Footer = () => {
  ...
  {/* this is the footer section and will be there in all pages  */}
    {/* <Section crosses className="" > */}
      <div className="  font-mono border-non container flex md:justify-between justify-center items-center mb-[-20px] gap-[30px] sm:gap-[140px] md:gap-[300px] max-sm:flex-col py-4" style={{borderTop:"2px solid gray"}} >
      ...
      <div className=" g-slate-500 opacity-90 z-1 p-5">
      <div className="relative">
        ...
        />
        <div className="absolute inset-0 bg-zinc-700 w-[320px] h-[250px]  sm:w-[450px] sm:h-[250px] ml-10 opacity-50 rounded-lg pointer-events-none"></div>
      </div>
      </div>
    </div>
