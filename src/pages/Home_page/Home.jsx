...
const App = () => {
  return (
    <>
      ...
      <div className=" flex flex-col align-center sm:w-full lg:ml-0 sm:ml-[200px] md:ml-[100px] mt-[-100px]  md:align-center pt-[4.75rem] lg:pt-[5.25rem] overflow-hidden  mx-auto w-full  ">
        <Hero />
        <FacultySection/>
        <EventsCard/>
        <ContactForm/>
